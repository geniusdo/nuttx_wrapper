...
void stm32_spidev_initialize(void)
{
  ...
  stm32_configgpio(BMI088_0_ACS);
  stm32_configgpio(BMI088_0_GCS);
#endif
#ifdef CONFIG_STM32H7_SPI4
  spiinfo("Configure GPIO for SPI4/CS\n");
  stm32_configgpio(BMI088_1_ACS);
  stm32_configgpio(BMI088_1_GCS);
#endif
                      ...
                      uint32_t devid, bool selected)
{
  switch (devid)
  {
      case 0 : // acc
        ...
        stm32_gpiowrite(BMI088_0_ACS, !selected);
        break;
      case 1 : // gyro
        spiinfo("gyro %s\n",
                selected ? "on" : "off");
        stm32_gpiowrite(BMI088_0_GCS, !selected);
        break;
      default:
        break;
  }
                      ...
                      uint32_t devid, bool selected)
{
  switch (devid)
  {
      case 0 : // acc
        ...
        /* Set the GPIO low to select and high to de-select */
        stm32_gpiowrite(BMI088_1_ACS, !selected);
        break;
      case 1 : // gyro
        spiinfo("gyro %s\n",
                selected ? "on" : "off");
        stm32_gpiowrite(BMI088_1_GCS, !selected);
        break;
      default:
        break;
  }
